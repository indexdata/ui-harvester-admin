...
* Tidy up Harvestable editing form in accordance with GBV's requests. Fixes UIHAADM-11.
* Tidy up Harvestable read-only display to match editing form. Fixes UIHAADM-12.
